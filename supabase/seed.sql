...
insert into public.services (id, category_id, name, description, price, duration_minutes, is_active) values
  ...
  ('enh-pink-white',       'enhancements', 'Pink & White',         'Pink & white acrylic — pricing from listed rates.', 55, 80, true),
  ('enh-pink-white-full',  'enhancements', 'Pink & White — Full Set', 'Pink & white full set (from).', 55, 80, true),
  ('enh-pink-white-fill',  'enhancements', 'Pink & White — Fill-In',  'Pink & white fill-in (from).', 45, 65, true),
  ('enh-pink-fill',        'enhancements', 'Pink & White — Pink Fill', 'Pink Fill service.', 45, 65, true),
